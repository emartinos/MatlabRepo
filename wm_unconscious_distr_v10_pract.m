 function wm_unconscious_distr_v10_pract
%%
% % ===================================================================== %
...
timings             = [1000 500 300 106]; % 1000/75
...
data.Ntrials  = 16;%length(data.conds);
...
title('CROSS ACC');
set(gca,'XTick',1:4, 'XTickLabelMode','manual', 'XTickLabel',{'1', '.5', '.3', '.106'},'FontSize',10)
xlim([0 5]);
...
data.prime_bgr = [0.1 0.1 0.1] .^ (1/gam);
